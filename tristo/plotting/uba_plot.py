...
colors = ['#61B931', '#125D86', '#009BD5', '#007626', '#FABB00',
          '#83053C', '#CE1F5E', '#D78400', '#9D579A', '#622F63', '#EDEDEE', '#4B4B4D']
cnames = ['lgr', 'db', 'lb', 'dgr', 'y', 'm', 'pink', 'or', 'lv', 'dv', 'lgrey', 'dgrey']
...
cmaps = {'cbar': matplotlib.colors.LinearSegmentedColormap.from_list(
    ...
    'red', [matplotlib.colors.to_rgb(c_uba['lgrey'])]*2)}
...
def backgr(self, hatch: str = '//////'):
    ...
    self.add_patch(Rectangle((l, b), r-l, t-b, fill=False,
                   hatch=hatch, lw=.1, ec=c_uba['lgrey'], zorder=0))
