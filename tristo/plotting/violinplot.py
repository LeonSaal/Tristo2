...
def violinplot(param:str, limit:float, unit:str, df:pd.DataFrame, ax=plt.Axes, legend=''):
    ...
    sns.violinplot(data=df, x='Parameter', y='val' , hue='category', split=True, inner='stick', ax=ax, density_norm='count', common_norm=True, cut=0, linewidth=.5, hue_order=categrories, palette=['C0','C2'])
